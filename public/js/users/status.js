...
var updateStatus = function updateStatus(order) {
  status.forEach(function (current) {
    current.classList.remove('completed');
    current.classList.remove('current');
  });
  var stepCompleted = true;
  status.forEach(function (current) {
    var statusProp = current.dataset.status;
    ...
    if (order.status === statusProp) {
      stepCompleted = false;
      time.innerHTML = moment__WEBPACK_IMPORTED_MODULE_0___default()(order.updatedAt).format('DD/MM/YY hh:mm A');
...
var order = JSON.parse(document.getElementById('order-provider').value);
var status = document.querySelectorAll('.status-line');
var time = document.createElement('small');
updateStatus(order); // Client-Side Socket Configurations...
...
socket.on('orderUpdated', function (data) {
  ...
  new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
    type: 'success',
    text: "Your Order is ".concat(data.status, " "),
    timeout: 1000,
    progressBar: false
  }).show();
});
...
/***/ 2:
/*!**************************************!*\
  !*** multi ./src/js/users/status.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\Dell\Documents\FCC\Projects\Full Stack Development\Greenshop\src\js\users\status.js */"./src/js/users/status.js");
