...
var stripe = Stripe(process.env.PK_TEST || "pk_test_TYooMQauvdEDq54NiTphI7jx");
document.querySelector('button').disabled = true; // Calls stripe.confirmCardPayment
...
var orderComplete = function orderComplete(shippingDetails, amount) {
  loading(false);
  document.querySelector("button").disabled = true;
  new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
    type: 'success',
    text: "Thankyou, We recieved ".concat(amount, " from you"),
    timeout: 800,
    progressBar: false
  }).show();
  setTimeout(function () {
    document.querySelector('#order-contact').value = shippingDetails.phone;
    document.querySelector('#order-address').value = "".concat(shippingDetails.address.line1, ", ").concat(shippingDetails.address.city, ", ").concat(shippingDetails.address.state, ", ").concat(shippingDetails.address.country);
...
axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/create-payment-intent').then(function (res) {
...
/***/ 3:
/*!**********************************!*\
  !*** multi ./src/js/checkout.js ***!
  \**********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\Dell\Documents\FCC\Projects\Full Stack Development\Greenshop\src\js\checkout.js */"./src/js/checkout.js");
